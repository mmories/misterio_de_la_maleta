...
{id:'plant',name:'planta',rect:[442,194,83,133],at:[530,360],look:'Está más adaptada al Colegio Mayor que yo. Y tampoco parece haber hecho amigos.'},
...
export const TALK={
welcome:[['Pedro','Tú debes de ser Julio.'],['Julito','Julito.'],['Pedro','Aquí todavía estás a tiempo de cambiar de nombre.'],['Pedro','Bienvenido a Deusto. ¿Qué necesitas?']],
...
place:[['Julito','¿Dónde estoy exactamente?'],['Pedro','En el Colegio Mayor Deusto. Bilbao. Octubre del 94.'],['Julito','Lo de Bilbao lo sabía.'],['Pedro','Estupendo. Ya llevas una asignatura aprobada.'],['Pedro','Comedor abajo, biblioteca al fondo. Si hueles croquetas, te has equivocado de silencio.']],
rules:[['Julito','¿Hay alguna norma que debería conocer?'],['Pedro','Hay muchas.'],['Pedro','Con que no descubras cuáles son, nos llevaremos bien.'],['Julito','¿Y las visitas?'],['Pedro','Se anuncian en recepción. Y las maletas no se dejan en los pasillos.'],['Julito','¿Eso último es muy importante?'],['Pedro','Digamos que ya hemos tenido suficiente equipaje por hoy.']],
weather:[['Julito','¿Siempre hace este tiempo en Bilbao?'],['Pedro','No, hombre. A veces llueve.'],['Julito','Está lloviendo.'],['Pedro','Esto es para que no se levante polvo.'],['Julito','No he traído paraguas.'],['Pedro','Pues ya tienes tema de conversación para todo el curso.']],
suitcase:[['Julito','¿Pasa algo con mi maleta?'],['Pedro','¿Con tu maleta?'],['Pedro','No. ¿Por qué iba a pasar algo?'],['Julito','Me ha parecido que la miraba.'],['Pedro','Miro muchas cosas. Es recepción.'],['Pedro','Los ascensores están al fondo.']],
after:[['Julito','¿Alguna cosa más?'],['Pedro','Sí. Tercera planta. Antes de que cambie de opinión.']],
locked:[['Pedro','Julio. Tu llave.'],['Julito','Julito.'],['Pedro','Eso también.']]
};
export function newState(){return {introCompleted:false,talkedToPedro:false,roomAssigned:false,hasKey310:false,hasMarca:false,inspectedMailbox:false,calledElevator:false,tookPapers:[],readTopics:[]};}
