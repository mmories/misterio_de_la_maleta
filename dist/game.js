...
function drawUmbrellaStand(){if(state.hasUmbrella)return;ctx.save();ctx.translate(478,418);ctx.fillStyle='rgba(4,8,8,.25)';ctx.beginPath();ctx.ellipse(0,8,19,3,0,0,Math.PI*2);ctx.fill();ctx.strokeStyle='#b99153';ctx.fillStyle='#60442b';ctx.lineWidth=2;ctx.beginPath();ctx.moveTo(-13,-2);ctx.lineTo(-9,7);ctx.lineTo(9,7);ctx.lineTo(13,-2);ctx.closePath();ctx.fill();ctx.stroke();ctx.strokeStyle='#191f22';ctx.lineWidth=4;ctx.beginPath();ctx.moveTo(0,-2);ctx.lineTo(0,-56);ctx.stroke();ctx.beginPath();ctx.arc(0,-58,5,Math.PI,0);ctx.stroke();ctx.fillStyle='#263138';ctx.beginPath();ctx.moveTo(-14,-51);ctx.lineTo(0,-71);ctx.lineTo(14,-51);ctx.closePath();ctx.fill();ctx.strokeStyle='#9eb3b0';ctx.lineWidth=1;ctx.stroke();ctx.restore();}
